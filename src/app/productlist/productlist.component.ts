...
export class ProductlistComponent implements OnInit {
  ...
  // import the IProducts interface and declare it using products: IProducts[].
  products: IProducts[];
  upproducts: IProducts[] = [];
  // selectedProduct is used to send data to another component productdetails.
  ...
  /**
   * So, you have create a new subject for selectedProduct in parent component. getpopup(list) function is used
   *  to pass selected product data to productdetails component using this.selectedProduct.next(det). det parameter
   *  holds the selected product value.
   */
  getpopup(det) {
